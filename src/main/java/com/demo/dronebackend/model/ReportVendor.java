...
import com.demo.dronebackend.config.LinkVendorMappingConfig;
...
public class ReportVendor {
    ...
    private final LinkVendorMappingConfig config;
    private final ObjectMapper objectMapper;


    public DroneReport DroneWithVendor(JsonNode raw, String vendor) {
        Map<String, String> fieldMap = config.getDroneMappings().get(vendor);
...
//        report.setVendor(vendor);
    ...
    public DeviceReport DeviceWithVendor(JsonNode raw, String vendor) {
        Map<String, String> fieldMap = config.getDeviceMappings().get(vendor);
